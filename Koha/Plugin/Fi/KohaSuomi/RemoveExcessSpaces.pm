package Koha::Plugin::Fi::KohaSuomi::RemoveExcessSpaces;
...
our $metadata = {
    ...
    author          => 'Lari Strand',
    date_authored   => '2024-08-19',
    date_updated    => '2024-08-19',
    minimum_version => '23.11',
    maximum_version => '',
    version         => $VERSION,
    description     => "Positaa ylimääräisiä välilyöntejä",
};
...
sub intranet_js {
    ...
    my $plugin_fulldir = $dir . "/Koha/Plugin/Fi/KohaSuomi/RemoveExcessSpaces/";
